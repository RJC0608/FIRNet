...
from lib.FIRNet import Network
from utils.data_val import test_dataset

parser = argparse.ArgumentParser()
parser.add_argument('--testsize', type=int, default=416, help='testing size')
parser.add_argument('--pth_path', type=str, default='/media/lab509-1/data1/RJC/FIRNet/snapshot/FIRNet/Net_epoch_best.pth')
...
for _data_name in ['CAMO', 'CHAMELEON', 'COD10K', 'NC4K']:
    ...
    save_path = './resp/{}/{}/'.format(opt.pth_path.split('/')[-2], _data_name)
    model = Network()
